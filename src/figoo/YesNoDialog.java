...
public class YesNoDialog extends javax.swing.JDialog {
     ...
     * @param fw
     */
    public YesNoDialog(java.awt.Frame parent, boolean modal, FigooView fw) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(figoo.FigooApp.class).getContext().getResourceMap(YesNoDialog.class);
